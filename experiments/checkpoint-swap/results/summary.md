...
Arms: body7_official, body7_self, aic_coco_self, coco_self.
...
| orientation | body7_official | body7_self | aic_coco_self | coco_self |
|---|---|---|---|---|
| FRONT | 0.004 [0.001, 0.011] n=804 | 0.004 [0.001, 0.011] n=804 | 0.001 [0.000, 0.007] n=804 | 0.002 [0.001, 0.009] n=804 |
| REAR | 0.010 [0.003, 0.030] n=293 | 0.010 [0.003, 0.030] n=293 | 0.010 [0.003, 0.030] n=293 | 0.014 [0.005, 0.035] n=293 |

### 2b. On RTMDet-Ins-tiny boxes, given correct selection - #19's condition, and the deployable one

| orientation | body7_official | body7_self | aic_coco_self | coco_self |
|---|---|---|---|---|
| FRONT | 0.003 [0.001, 0.010] n=730 | 0.003 [0.001, 0.010] n=730 | 0.003 [0.001, 0.010] n=730 | 0.003 [0.001, 0.010] n=730 |
| OBLIQUE | 0.033 [0.018, 0.057] n=337 | 0.033 [0.018, 0.057] n=337 | 0.030 [0.016, 0.054] n=337 | 0.030 [0.016, 0.054] n=337 |
| PROFILE | 0.000 [-0.000, 0.046] n=80 | 0.000 [-0.000, 0.046] n=80 | 0.000 [-0.000, 0.046] n=80 | 0.000 [-0.000, 0.046] n=80 |
| REAR | 0.020 [0.009, 0.042] n=304 | 0.020 [0.009, 0.042] n=304 | 0.016 [0.007, 0.038] n=304 | 0.023 [0.011, 0.047] n=304 |

Sign-confirmed only:

| orientation | body7_official | body7_self | aic_coco_self | coco_self |
|---|---|---|---|---|
| FRONT | 0.003 [0.001, 0.010] n=706 | 0.003 [0.001, 0.010] n=706 | 0.003 [0.001, 0.010] n=706 | 0.003 [0.001, 0.010] n=706 |
| REAR | 0.012 [0.004, 0.035] n=251 | 0.012 [0.004, 0.035] n=251 | 0.004 [0.001, 0.022] n=251 | 0.012 [0.004, 0.035] n=251 |
...
| orientation | body7_official | body7_self | aic_coco_self | coco_self |
|---|---|---|---|---|
| FRONT | 0.9500 | 0.9500 | 0.9555 | 0.9512 |
| OBLIQUE | 0.9249 | 0.9249 | 0.9315 | 0.9243 |
| PROFILE | 0.9292 | 0.9292 | 0.9320 | 0.9268 |
| REAR | 0.9297 | 0.9297 | 0.9325 | 0.9264 |

On RTMDet-Ins-tiny boxes, given correct selection:

| orientation | body7_official | body7_self | aic_coco_self | coco_self |
|---|---|---|---|---|
| FRONT | 0.9536 | 0.9536 | 0.9576 | 0.9540 |
| OBLIQUE | 0.9256 | 0.9256 | 0.9345 | 0.9270 |
| PROFILE | 0.9300 | 0.9300 | 0.9340 | 0.9253 |
| REAR | 0.9357 | 0.9357 | 0.9388 | 0.9327 |

PCK@0.2 after correcting chirality, ground-truth boxes:

| orientation | body7_official | body7_self | aic_coco_self | coco_self |
|---|---|---|---|---|
| FRONT | 0.9919 | 0.9919 | 0.9938 | 0.9913 |
| OBLIQUE | 0.9804 | 0.9804 | 0.9850 | 0.9758 |
| PROFILE | 0.9828 | 0.9828 | 0.9825 | 0.9769 |
| REAR | 0.9765 | 0.9765 | 0.9798 | 0.9737 |
...
| orientation | body7_official | body7_self | aic_coco_self | coco_self |
|---|---|---|---|---|
| FRONT | 0.9501 | 0.9501 | 0.9552 | 0.9509 |
| OBLIQUE | 0.9241 | 0.9241 | 0.9293 | 0.9231 |
| PROFILE | 0.9292 | 0.9292 | 0.9320 | 0.9219 |
| REAR | 0.9206 | 0.9206 | 0.9246 | 0.9145 |
...
| orientation | body7_official | body7_self | aic_coco_self | coco_self |
|---|---|---|---|---|
| FRONT | 0.875 [0.851, 0.896] n=832 | 0.875 [0.851, 0.896] n=832 | 0.875 [0.851, 0.896] n=832 | 0.875 [0.851, 0.896] n=832 |
| OBLIQUE | 0.849 [0.810, 0.881] n=384 | 0.849 [0.810, 0.881] n=384 | 0.852 [0.813, 0.884] n=384 | 0.852 [0.813, 0.884] n=384 |
| PROFILE | 0.833 [0.746, 0.895] n=96 | 0.833 [0.746, 0.895] n=96 | 0.833 [0.746, 0.895] n=96 | 0.833 [0.746, 0.895] n=96 |
| REAR | 0.821 [0.778, 0.857] n=363 | 0.821 [0.778, 0.857] n=363 | 0.824 [0.781, 0.859] n=363 | 0.818 [0.775, 0.854] n=363 |
